...
public class BookingIntegrationTest {
    ...
    void getAllBookingsTest() {
        ...
        Assertions.assertEquals(itemDto.getName(), resultList.get(0).getItem().getName());
        Assertions.assertEquals(userDto2.getName(), resultList.get(0).getBooker().getName());
        Assertions.assertEquals(Status.WAITING, resultList.get(0).getStatus());
    }
}