...
public class BookingRepositoryTest {
    ...
    void findByItemIdAndOwnerId() {
        ...
        Assertions.assertThat(result).contains(booking);
    }
    ...
    void findAllBookings() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.getContent()).contains(booking, booking2);
    }
    ...
    void findCurrentBookings() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.getContent()).contains(currentBooking);
        Assertions.assertThat(result.getContent()).doesNotContain(pastBooking, futureBooking);
    }
    ...
    void findPastBookings() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.getContent()).contains(pastBooking1, pastBooking2);
    }
    ...
    void findFutureBookings() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.getContent()).contains(futureBooking1, futureBooking2);
    }
    ...
    void findBookingsByWaiting() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result.getContent()).contains(waitingBooking1, waitingBooking2);
        Assertions.assertThat(result.getContent()).doesNotContain(confirmedBooking);
    }
    ...
    void findLastBookingForItem() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result).contains(booking2);
    }
    ...
    void findNextBookingForItem() {
        ...
        Assertions.assertThat(result).isNotEmpty();
        Assertions.assertThat(result).contains(booking1);
    }
}